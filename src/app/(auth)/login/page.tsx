...
export default function Login() {
    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="flex flex-col justify-center items-center bg-white/30 p-3 w-100 rounded-xl gap-2">
                <form className=" flex justify-center items-center flex-col gap-3">
                    ...
                    <h1 className="text-4xl font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Welcome Back</h1>
