    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="flex flex-col justify-center items-center bg-white/30 p-5 w-100 rounded-xl gap-2">
                <form className=" flex justify-center items-center flex-col gap-3 w-full" onSubmit={handleEmailSignUp}>
                    ...
                    <div className="flex flex-col gap-1 w-full my-2 text-sm">
                        ...
                        <input type="name" name="name" id="name" placeholder="Jhon Doe" className="outline-none bg-white px-2 py-3 rounded-lg" value={formData.name} onChange={handleChange} />
                    </div>
                    <div className="flex flex-col gap-1 w-full my-2 text-sm">
                        <label htmlFor="email" className="font-semibold">Email Address</label>
                        <input type="email" name="email" id="email" placeholder="jhon@example.com" className="outline-none bg-white px-2 py-3 rounded-lg" value={formData.email} onChange={handleChange} />
                    </div>
                    <div className="flex flex-col gap-1 w-full text-sm">
                        <label htmlFor="password" className="font-semibold">Password</label>
                        <div className="bg-white px-2 py-3 rounded-lg flex justify-between">
                            <input type={`${isClicked ? "text" : "password"}`} name="password" id="password" placeholder="Enter Your Password" className="outline-none " value={formData.password} onChange={handleChange} />
