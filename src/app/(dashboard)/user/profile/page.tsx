...
export default function ProfilePage() {
    ...
    const [editAddressForm, setEditAddressForm] = useState<boolean>(false);
        ...
        <>
                    ...
                    <div className="flex flex-col w-full md:w-2/3 justify-center items-center gap-4">
                        ...
                        <div className="bg-white/30 border-1 border-white backdrop-blur-xl rounded-lg shadow-lg p-6 flex flex-col gap-4 w-full">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <button className="flex justify-center items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-tr from-gray-500 to-gray-600 text-sm text-white hover:from-gray-700 hover:to-gray-800" onClick={() => setEditAddressForm(true)}>
                                    Edit Address<FaPencil />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                ...
                {editAddressForm && (
                    <EditAddressForm
                        userData={userData}
                        setEditForm={setEditAddressForm}
